    ...
    <div class="dashboard-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-header">
                ...
                <p class="page-subtitle">Selamat datang kembali, <strong><?php echo htmlspecialchars($userData['nama']); ?></strong></p>
            </div>
                ...
                <div class="dashboard-card">
                    ...
                    <div class="card-value" style="font-size: 18px;">
                        <?php if ($currentPengajuan): ?>
                            <span class="status-badge status-<?php echo strtolower(str_replace(' ', '', $currentPengajuan['status'])); ?>">
            ...
            <?php if ($currentPengajuan): ?>
                <div class="form-card">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><?php echo date('d F Y, H:i', strtotime($currentPengajuan['tanggal_dibuat'])); ?> WIB</td>
                                </tr>
                                <tr>
                        ...
                        <div class="col-md-4">
                            <div style="background: linear-gradient(135deg, var(--color-secondary) 0%, var(--color-background) 100%); padding: 24px; border-radius: 12px; text-align: center;">
                                <i class="fas fa-clock" style="font-size: 48px; color: var(--color-primary); margin-bottom: 12px;"></i>
                                <h4 style="font-size: 16px; font-weight: 600; margin-bottom: 8px;">Sedang Diproses</h4>
                                <p style="font-size: 13px; color: #6b7280; margin: 0;">Pengajuan Anda sedang dalam tahap <?php echo strtolower($currentPengajuan['status']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        <div style="text-align: center; padding: 20px;">
                            <div style="width: 64px; height: 64px; background: linear-gradient(135deg, #dbeafe 0%, #bfdbfe 100%); border-radius: 14px; display: flex; align-items: center; justify-content: center; margin: 0 auto 16px; color: #1e40af; font-size: 28px;">
                                <i class="fas fa-shield-alt"></i>
                            </div>
                            <h4 style="font-size: 16px; font-weight: 600; margin-bottom: 8px;">Transparan</h4>
                            <p style="font-size: 13px; color: #6b7280; line-height: 1.6;">Proses seleksi menggunakan metode SAW yang objektif dan terukur</p>
                        </div>
                    </div>

                    <div class="col-md-4">
                        <div style="text-align: center; padding: 20px;">
                            <div style="width: 64px; height: 64px; background: linear-gradient(135deg, #d1fae5 0%, #a7f3d0 100%); border-radius: 14px; display: flex; align-items: center; justify-content: center; margin: 0 auto 16px; color: #065f46; font-size: 28px;">
                                <i class="fas fa-check-double"></i>
                            </div>
                            <h4 style="font-size: 16px; font-weight: 600; margin-bottom: 8px;">Terpercaya</h4>
                            <p style="font-size: 13px; color: #6b7280; line-height: 1.6;">Data Anda aman dan hanya digunakan untuk verifikasi kelayakan</p>
                        </div>
                    </div>

                    <div class="col-md-4">
                        <div style="text-align: center; padding: 20px;">
                            <div style="width: 64px; height: 64px; background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); border-radius: 14px; display: flex; align-items: center; justify-content: center; margin: 0 auto 16px; color: #92400e; font-size: 28px;">
                                <i class="fas fa-clock"></i>
                            </div>
                            <h4 style="font-size: 16px; font-weight: 600; margin-bottom: 8px;">Cepat</h4>
                            <p style="font-size: 13px; color: #6b7280; line-height: 1.6;">Proses verifikasi dilakukan secara otomatis dan efisien</p>
                        </div>
                    </div>
                </div>
            </div>
